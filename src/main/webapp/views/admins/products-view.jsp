      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col text-end">
            <button type="button" data-bs-toggle="modal" data-bs-target="#createProduct"
          ...
          <s:forEach items="${products}" var="product" varStatus="s">
            <tr>
              ...
              <td>
                <div class="row">
                  <div class="col-2">
                    <button type="button" class="btn btn-sm d-inline" data-bs-toggle="modal"
                            data-bs-target="#updateProduct"
                            data-id_product="${product.id_product}"
                            data-name="${product.name}"
                            data-concept="${product.concept}"
                            data-price="${product.price}"
                            data-piece="${product.piece}">
                      <img src="/assets/img/pen-to-square-solid.svg"
                           style="height: 30px">
                    </button>
                  </div>
                  <div class="col-2">
                    <form id="deleteProductForm_${id_product}"
                          action="/api/product/delete" method="post"
                          onclick="confirmarEliminar(event, ${product.id_product})">
                      <input hidden value="${product.id_product}" name="id_product">
