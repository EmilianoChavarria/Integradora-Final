...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="height: 80px">
    ...
    <div class="d-inline">
        <a class="navbar-brand ms-3 fw-semibold" href="/client/main">SIGMA - Sistema de Gestión de Mantenimiento a Automóviles</a>
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link mt-2 ms-4 btn btn-outline-secondary" href="/client/vehicle"><h5>Mis Vehículos</h5></a>
            </li>
